...
class Camera():
    ...
    def imageProcess(self):
        ...
        # Based on user input (Option 1 or 2) capturing images, storing and resultrieving.
            if result:
                ...
                of an image. The cv.HOGDescriptor() method creates the HOG descriptor. The hog.setSVMDetector() method 
    ...
    def videoCapture(self):
        ...
        if self.nof_people > 0:
            ...
            while ((time.time() - startTime) < capture_duration):
